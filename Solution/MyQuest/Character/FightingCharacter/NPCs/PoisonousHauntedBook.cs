...
namespace MyQuest
{
    class PoisonousHauntedBook : NPCFightingCharacter
    {
        ...
        public PoisonousHauntedBook()
        {
            Name = "Poisonous Haunted Book";
            ...
            {
                Name = "Idle",
                TextureName = "hauntedbook_green_idle",
            ...
            {
                Name = "Attack",
                TextureName = "possessed_book_green_attack",

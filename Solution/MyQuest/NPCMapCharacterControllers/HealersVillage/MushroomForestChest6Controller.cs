...
namespace MyQuest
{
    public class MushroomForestChest6Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z488);  //Declare the dialog variable

         public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(RingOfTheSages), 1);  //Adds a Ring of Justice item to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "MushroomForestChest6",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest6",
                new Point(39, 42),  //OpenChest1 is added at position (39,42). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

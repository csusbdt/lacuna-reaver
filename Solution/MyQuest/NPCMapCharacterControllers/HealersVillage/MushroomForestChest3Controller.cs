...
namespace MyQuest
{
    public class MushroomForestChest3Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "MushroomForestChest3",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest3",
                new Point(26, 44),  //OpenChest3 is added at position (26,44). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

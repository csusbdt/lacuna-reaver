...
namespace MyQuest
{
    public class Keepf2ChestController : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z132);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(BattleLordsRing), 1);  //Adds the Small Health Potion item to the inventory
            ...
            Party.Singleton.ModifyNPC(
                ...
                "Keepf2Chest",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest1",
                new Point(5, 4),  //OpenChest1 is added at position (5,4). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

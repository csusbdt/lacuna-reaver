...
namespace MyQuest
{
    public class BlindMansForestChest8Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z119);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(MediumEnergyPotion), 1);  //Adds a Ring of The Sages to the inventory

            Party.Singleton.ModifyNPC(
                "blind_mans_forest_4",  //Select the map where the modification is applied. Current map in this case.
                "BlindMansForestChest8",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                "blind_mans_forest_4",
                "OpenChest8",
                new Point(54, 34),  //OpenChest4 is added at position (54,34). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

...
namespace MyQuest
{
    public class BlindMansForestChest6Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.ZA611);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(RubyRing), 1);  //Adds a Ring of Bravura to the inventory

            Party.Singleton.ModifyNPC(
                "blind_mans_forest_3",  //Select the map where the modification is applied. Current map in this case.
                "BlindMansForestChest6",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                "blind_mans_forest_3",
                "OpenChest6",
                new Point(22, 31),  //OpenChest3 is added at position (22,31). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

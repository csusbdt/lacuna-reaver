...
namespace MyQuest
{
    public class BlindMansForestChest1Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z485);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(RingOfCalling), 1);  //Adds a RingOfCalling to Inventory

            Party.Singleton.ModifyNPC(
                "blind_mans_forest_1",  //Select the map where the modification is applied. Current map in this case.
                "BlindMansForestChest1",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                "blind_mans_forest_1",
                "OpenChest1",
                new Point(2, 27),  //OpenChest2 is added at position (2,27). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

...
namespace MyQuest
{
    public class BlindMansForestChest4Controller : NPCMapCharacterController
    {
        ...
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(SmallHealthPotion), 1);  //Adds a small health potion to the inventory

            Party.Singleton.ModifyNPC(
                "blind_mans_forest_3",  //Select the map where the modification is applied. Current map in this case.
                "BlindMansForestChest4",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                "blind_mans_forest_3",
                "OpenChest4",
                new Point(15,9),  //OpenChest3 is added at position (15,9). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

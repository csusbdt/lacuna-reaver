...
namespace MyQuest
{
    public class BlindMansForestChest5Controller : NPCMapCharacterController
    {
        ...
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(SmallEnergyPotion), 1);  //Adds a small energy potion to the inventory

            Party.Singleton.ModifyNPC(
                "blind_mans_forest_3",  //Select the map where the modification is applied. Current map in this case.
                "BlindMansForestChest5",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                "blind_mans_forest_3",
                "OpenChest5",
                new Point(16,9),  //OpenChest3 is added at position (16,9). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

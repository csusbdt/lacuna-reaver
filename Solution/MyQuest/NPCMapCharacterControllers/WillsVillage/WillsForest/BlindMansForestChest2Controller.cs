...
namespace MyQuest
{
    public class BlindMansForestChest2Controller : NPCMapCharacterController
    {
        ...
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(MediumHealthPotion), 1);  //Adds the Large Health Potion item to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "BlindMansForestChest2",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest2",
                new Point(26,2),  //OpenChest3 is added at position (26,2). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

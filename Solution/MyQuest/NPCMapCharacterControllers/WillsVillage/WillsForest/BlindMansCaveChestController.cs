...
namespace MyQuest
{
    public class BlindMansCaveChestController : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.ZA508);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Gold+=750;  

            Party.Singleton.ModifyNPC(
                "blind_mans_forest_cave",  //Select the map where the modification is applied. Current map in this case.
                "BlindMansCaveChest",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                "blind_mans_forest_cave",
                "OpenChest1",
                new Point(4, 2),  //OpenChest2 is added at position (2,27). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

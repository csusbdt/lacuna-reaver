...
namespace MyQuest
{
    public class CaveLabyrinthChest17Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.ZA615);  //Declare the dialog variable
        ...
        public void Complete()
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "CaveLabyrinthChest17",  //The name of the npc being modified

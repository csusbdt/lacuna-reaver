...
namespace MyQuest
{
    public class CaveLabyrinthChest18Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z124);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(NatureCharm), 1);  //Adds a Battle Lord's Ring to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "CaveLabyrinthChest18",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest18",
                new Point(51,98),  //OpenChest3 is added at position (51,98). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

...
namespace MyQuest
{
    public class CaveLabyrinthChest6Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z123);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(ChainOfSkies), 1);  //Adds a Chain of Skies to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "CaveLabyrinthChest6",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest6",
                new Point(54,30),  //OpenChest3 is added at position (54,30). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

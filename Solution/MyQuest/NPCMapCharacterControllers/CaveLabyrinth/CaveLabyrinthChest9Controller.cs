...
namespace MyQuest
{
    public class CaveLabyrinthChest9Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z125);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(ChainOfFlame), 1);  //Adds a Chain of Flame to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "CaveLabyrinthChest9",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest9",
                new Point(6,26),  //OpenChest3 is added at position (6,26). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

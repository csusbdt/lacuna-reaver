...
namespace MyQuest
{
    public class CaveLabyrinthChest3Controller : NPCMapCharacterController
    {
        ...
        public void Complete()
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "CaveLabyrinthChest3",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest3",
                new Point(75,54),  //OpenChest3 is added at position (75,54). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

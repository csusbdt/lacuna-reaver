...
namespace MyQuest
{
    public class CaveLabyrinthChest4Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z118);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(LargeHealthPotion), 1);  //Adds a Battle Mage Ring to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "CaveLabyrinthChest4",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest4",
                new Point(99,2),  //OpenChest3 is added at position (99,2). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

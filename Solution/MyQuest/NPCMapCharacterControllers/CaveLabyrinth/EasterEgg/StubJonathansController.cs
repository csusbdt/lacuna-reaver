...
namespace MyQuest
{
    public class StubJonathansController : NPCMapCharacterController
    {
        #region Achivements
        ...
        static readonly Dialog jonathanDialog = new Dialog(DialogPrompt.NeedsClose, Strings.ZA715);
        ...
        public override void Interact()
        {
            ...
            NPCMapCharacter stub = Party.Singleton.CurrentMap.GetNPC("StubJonathan");

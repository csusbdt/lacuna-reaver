...
namespace MyQuest
{
    public class StubDavidsController : NPCMapCharacterController
    {
        #region Achivements
        ...
        static readonly Dialog davidDialog = new Dialog(DialogPrompt.NeedsClose, Strings.ZA712);
        ...
        public override void Interact()
        {
            ...
            NPCMapCharacter stub = Party.Singleton.CurrentMap.GetNPC("StubDavid");

...
namespace MyQuest
{
    public class CaveLabyrinthChest12Controller : NPCMapCharacterController
    {
        ...
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(LargeHealthPotion), 1);  //Adds a Medium health potion to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "CaveLabyrinthChest12",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest12",
                new Point(35,46),  //OpenChest3 is added at position (35,46). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

...
namespace MyQuest
{
    public class CaveLabyrinthChest11Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z127);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(ChainOfTheSea), 1);  //Adds a Chain of the Sea to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "CaveLabyrinthChest11",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest11",
                new Point(22,34),  //OpenChest3 is added at position (22,34). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

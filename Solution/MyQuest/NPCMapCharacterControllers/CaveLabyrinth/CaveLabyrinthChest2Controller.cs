...
namespace MyQuest
{
    public class CaveLabyrinthChest2Controller : NPCMapCharacterController
    {
        ...
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(LargeHealthPotion), 1);  //Adds a Medium energy potion to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "CaveLabyrinthChest2",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest2",
                new Point(94,70),  //OpenChest3 is added at position (94,70). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

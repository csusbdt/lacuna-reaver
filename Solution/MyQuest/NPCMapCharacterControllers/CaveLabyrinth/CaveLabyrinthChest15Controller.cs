...
namespace MyQuest
{
    public class CaveLabyrinthChest15Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z129);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(SpikedChain), 1);  //Adds a Spiked Chain to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "CaveLabyrinthChest15",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest15",
                new Point(22,82),  //OpenChest3 is added at position (22,82). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

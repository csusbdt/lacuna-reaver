...
namespace MyQuest
{
    public class CaveLabyrinthChest10Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z126);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(EarthenGloves), 1);  //Adds a Earthen Gloves to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "CaveLabyrinthChest10",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest10",
                new Point(18,34),  //OpenChest3 is added at position (18,34). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

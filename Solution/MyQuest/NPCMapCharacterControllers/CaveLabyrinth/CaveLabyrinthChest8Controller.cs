...
namespace MyQuest
{
    public class CaveLabyrinthChest8Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z124);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(NatureCharm), 1);  //Adds a Nature Charm to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "CaveLabyrinthChest8",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest8",
                new Point(7,10),  //OpenChest3 is added at position (7,10). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

...
namespace MyQuest
{
    public class CaveLabyrinthChest7Controller : NPCMapCharacterController
    {
        ...
        public void Complete()
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "CaveLabyrinthChest7",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest7",
                new Point(3,2),  //OpenChest3 is added at position (3,2). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

...
namespace MyQuest
{
    public class SewnBogChest8Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z343);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(TranslucentRing), 1);  //Adds a Jade Statue to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "SewnBogChest8",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest8",
                new Point(2, 12),  //OpenChest4 is added at position (1,12). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

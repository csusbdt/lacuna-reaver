...
namespace MyQuest
{
    public class SewnBogChest3Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z119);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(MediumEnergyPotion), 1);  //Adds the Medium Energy Potion item to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "SewnBogChest3",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest3",
                new Point(14, 4),  //OpenChest3 is added at position (14,4). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

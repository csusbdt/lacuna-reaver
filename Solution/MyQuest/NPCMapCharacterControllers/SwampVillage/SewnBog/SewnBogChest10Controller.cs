...
namespace MyQuest
{
    public class SewnBogChest10Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.ZA565);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(DivineRing), 1);  //Adds a Lapiz Lazuli Ring to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "SewnBogChest10",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest10",
                new Point(25, 45),  //OpenChest4 is added at position (25,45). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

...
namespace MyQuest
{
    public class SewnBogChest7Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z344);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(ShadowStrikeRing), 1);  //Adds a Shadow Strike Ring to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "SewnBogChest7",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest7",
                new Point(5, 20),  //OpenChest4 is added at position (5,20). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

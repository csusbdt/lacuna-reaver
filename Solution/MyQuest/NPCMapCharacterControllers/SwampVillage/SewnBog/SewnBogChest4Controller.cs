...
namespace MyQuest
{
    public class SewnBogChest4Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z343);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(TranslucentRing), 1);  //Adds a Translucent Ring to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "SewnBogChest4",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest4",
                new Point(1, 24),  //OpenChest4 is added at position (1,24). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

...
namespace MyQuest
{
    public class SewnBogChest6Controller : NPCMapCharacterController
    {
        ...
        public void Complete()
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "SewnBogChest6",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest6",
                new Point(31, 22),  //OpenChest3 is added at position (31,22). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

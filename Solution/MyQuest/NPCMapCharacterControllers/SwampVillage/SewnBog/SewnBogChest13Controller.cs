...
namespace MyQuest
{
    public class SewnBogChest13Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z122);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(LargeEnergyPotion), 1);  //Adds a Obsidian Charm to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "SewnBogChest13",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest13",
                new Point(11, 46),  //OpenChest4 is added at position (11,46). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

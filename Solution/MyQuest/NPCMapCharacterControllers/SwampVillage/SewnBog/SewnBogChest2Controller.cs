...
namespace MyQuest
{
    public class SewnBogChest2Controller : NPCMapCharacterController
    {
        ...
        public void Complete()
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "SewnBogChest2",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest2",
                new Point(8, 11),  //OpenChest3 is added at position (8,11). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

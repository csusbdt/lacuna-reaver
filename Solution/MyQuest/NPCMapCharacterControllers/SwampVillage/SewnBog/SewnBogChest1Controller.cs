...
namespace MyQuest
{
    public class SewnBogChest1Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z342);  //Declare the dialog variable

        public void Complete()
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(SkirmishRing), 1);  //Adds a Skirmish Ring to the inventory

            Party.Singleton.ModifyNPC(
                Party.Singleton.CurrentMap.Name,  //Select the map where the modification is applied. Current map in this case.
                "SewnBogChest1",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest1",
                new Point(3, 5),  //OpenChest4 is added at position (3,5). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

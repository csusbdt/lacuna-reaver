...
namespace MyQuest
{
    public class SewnBogChest11Controller : NPCMapCharacterController
    {
        ...
        public void Complete()
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "SewnBogChest11",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest11",
                new Point(8, 8),  //OpenChest4 is added at position (8,8). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

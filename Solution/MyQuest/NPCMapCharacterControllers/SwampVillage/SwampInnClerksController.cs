...
namespace MyQuest
{
    public class SwampInnClerksController : NPCMapCharacterController
    {
        #region Fields
        ...
        void Resting(object sender, PartyResponseEventArgs e)
        {
            ...
            CutSceneScreen screen = Utility.CreateInstanceFromName<CutSceneScreen>(this.GetType().Namespace, "WakeUpSwampInnCutSceneScreen");

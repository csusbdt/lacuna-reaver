...
namespace MyQuest
{
    public class RandomCave1Chest3Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.ZA267);  //Declare the dialog variable
        ...
        public void Complete()
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "RandomCave1Chest3",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest3",
                new Point(5, 3),  //OpenChest1 is added at position (5,4). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

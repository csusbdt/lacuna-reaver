...
namespace MyQuest
{
    public class Dungeon4MonsterChest4Controller : NPCMapCharacterController
    {
        ...
        void MonsterChestBattle(object sender, PartyResponseEventArgs e)
        {
            ...
            CombatZone zone = new CombatZone("4Dungeon4", 0f, CombatZonePool.caveBG, AudioCues.minibossCue, runningEnabled, CombatZonePool.fiveMediumLayoutCollection, monsters);

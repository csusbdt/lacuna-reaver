...
namespace MyQuest
{
    public class Dungeon4MonsterChest5Controller : NPCMapCharacterController
    {
        ...
        void MonsterChestBattle(object sender, PartyResponseEventArgs e)
        {
            ...
            Monster[] monsters = new Monster[] { new Monster(Monster.frostFlyder, 1, SlotSize.Medium, 1), new Monster(Monster.frostFlyder, 1, SlotSize.Medium, 1), new Monster(Monster.boggimusTadpole, 1, SlotSize.Medium, 1), 
                new Monster(Monster.voodooDoll, 1, SlotSize.Medium, 1), new Monster(Monster.voodooDoll, 1, SlotSize.Medium, 1) };
            CombatZone zone = new CombatZone("4Dungeon5", 0f, CombatZonePool.caveBG, AudioCues.minibossCue, runningEnabled, CombatZonePool.fiveMediumLayoutCollection, monsters);

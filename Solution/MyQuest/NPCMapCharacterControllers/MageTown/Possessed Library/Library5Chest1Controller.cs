...
namespace MyQuest
{
    public class Library5Chest1Controller : NPCMapCharacterController
    {
        ...
        public void Complete()
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "Library5Chest1",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest1",
                new Point(11, 12),  //OpenChest1 is added at position (11,12) Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);
        }

...
namespace MyQuest
{
    public class ForbiddenCavernHighChest6Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernHighChest6",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest6",
                new Point(89,66),  //OpenChest6 is added at position (13,30). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

...
namespace MyQuest
{
    public class ForbiddenCavernLowChest9Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernLowChest9",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest17",
                new Point(53,39),  //OpenChest9 is added at position (53,39). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

...
namespace MyQuest
{
    public class ForbiddenCavernLowChest6Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernLowChest6",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest14",
                new Point(86,32),  //OpenChest6 is added at position (86,32). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

...
namespace MyQuest
{
    public class ForbiddenCavernHighChest5Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernHighChest5",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest5",
                new Point(68,54),  //OpenChest5 is added at position (55,24). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

...
namespace MyQuest
{
    public class ForbiddenCavernLowChest3Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernLowChest3",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest11",
                new Point(100,19),  //OpenChest3 is added at position (100,19). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

...
namespace MyQuest
{
    public class ForbiddenCavernRoomAChest2Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernRoomAChest2",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest2",
                new Point(2,8),  //OpenChest2 is added at position (2,8). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

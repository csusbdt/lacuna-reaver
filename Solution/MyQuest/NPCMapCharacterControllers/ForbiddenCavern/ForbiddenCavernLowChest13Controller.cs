...
namespace MyQuest
{
    public class ForbiddenCavernLowChest13Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernLowChest13",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest21",
                new Point(75,68),  //OpenChest13 is added at position (75,68). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

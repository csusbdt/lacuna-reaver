...
namespace MyQuest
{
    public class ForbiddenCavernLowChest7Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernLowChest7",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest15",
                new Point(49,38),  //OpenChest7 is added at position (49,38). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

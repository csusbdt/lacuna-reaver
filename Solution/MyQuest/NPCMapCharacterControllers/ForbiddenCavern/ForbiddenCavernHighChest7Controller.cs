...
namespace MyQuest
{
    public class ForbiddenCavernHighChest7Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernHighChest7",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest7",
                new Point(36,73),  //OpenChest7 is added at position (68,54). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

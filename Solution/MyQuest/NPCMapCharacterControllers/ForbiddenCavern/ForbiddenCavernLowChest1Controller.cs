...
namespace MyQuest
{
    public class ForbiddenCavernLowChest1Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernLowChest1",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest9",
                new Point(62, 19),  //OpenChest1 is added at position (62,19). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

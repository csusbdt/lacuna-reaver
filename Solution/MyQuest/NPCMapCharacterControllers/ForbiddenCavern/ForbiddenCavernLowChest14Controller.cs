...
namespace MyQuest
{
    public class ForbiddenCavernLowChest14Controller : NPCMapCharacterController
    {
        ...
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(GreenMark), 1);  //Adds the Small Energy Potion item to the inventory

            Party.Singleton.ModifyNPC(
                Maps.forbiddenCavernLow,  //Select the map where the modification is applied. Current map in this case.
                "ForbiddenCavernLowChest14",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest22",
                new Point(65,79),  //OpenChest14 is added at position (65,79). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

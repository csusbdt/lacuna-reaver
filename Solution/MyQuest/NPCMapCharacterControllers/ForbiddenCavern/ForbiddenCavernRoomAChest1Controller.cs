...
namespace MyQuest
{
    public class ForbiddenCavernRoomAChest1Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernRoomAChest1",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest1",
                new Point(8, 2),  //OpenChest1 is added at position (5,4). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

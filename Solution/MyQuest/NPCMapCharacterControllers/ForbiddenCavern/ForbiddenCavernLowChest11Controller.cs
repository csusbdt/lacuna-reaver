...
namespace MyQuest
{
    public class ForbiddenCavernLowChest11Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                Maps.forbiddenCavernLow,  //Select the map where the modification is applied. Current map in this case.
                "ForbiddenCavernLowChest11",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest19",
                new Point(106,61),  //OpenChest11 is added at position (106,61). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

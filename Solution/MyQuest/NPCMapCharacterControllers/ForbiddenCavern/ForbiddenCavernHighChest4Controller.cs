...
namespace MyQuest
{
    public class ForbiddenCavernHighChest4Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernHighChest4",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest4",
                new Point(55,24),  //OpenChest4 is added at position (54,24). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

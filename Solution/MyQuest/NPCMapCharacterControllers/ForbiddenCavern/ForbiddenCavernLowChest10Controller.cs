...
namespace MyQuest
{
    public class ForbiddenCavernLowChest10Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernLowChest10",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest18",
                new Point(88,42),  //OpenChest10 is added at position (88,42). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

...
namespace MyQuest
{
    public class ForbiddenCavernLowChest2Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernLowChest2",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest10",
                new Point(45,19),  //OpenChest2 is added at position (45,19). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

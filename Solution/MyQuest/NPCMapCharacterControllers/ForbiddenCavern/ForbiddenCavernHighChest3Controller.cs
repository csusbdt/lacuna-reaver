...
namespace MyQuest
{
    public class ForbiddenCavernHighChest3Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernHighChest3",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest3",
                new Point(54,24),  //OpenChest3 is added at position (45,19). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

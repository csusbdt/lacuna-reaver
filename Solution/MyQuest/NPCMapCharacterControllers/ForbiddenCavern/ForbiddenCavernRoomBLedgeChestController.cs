...
namespace MyQuest
{
    public class ForbiddenCavernRoomBLedgeChestController : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                Maps.forbiddenCavernRoombLedge,  //Select the map where the modification is applied. Current map in this case.
                "ForbiddenCavernRoomBLedgeChest",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernRoomBLedgeChest",
                Point.Zero,
                ModAction.Remove,
                true);

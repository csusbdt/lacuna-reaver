...
namespace MyQuest
{
    public class ForbiddenCavernHighChest8Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernHighChest8",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest8",
                new Point(48,79),  //OpenChest8 is added at position (89,66). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

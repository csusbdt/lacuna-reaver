...
namespace MyQuest
{
    public class ForbiddenCavernLowChest15Controller : NPCMapCharacterController
    {
        ...
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(RedMark), 1);  //Adds the Small Health Potion item to the inventory

            Party.Singleton.ModifyNPC(
                Maps.forbiddenCavernLow,  //Select the map where the modification is applied. Current map in this case.
                "ForbiddenCavernLowChest15",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest23",
                new Point(54,90),  //OpenChest15 is added at position (54,90). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

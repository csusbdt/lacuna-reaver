...
namespace MyQuest
{
    public class ForbiddenCavernLowChest12Controller : NPCMapCharacterController
    {
        Dialog giveDialog = new Dialog(DialogPrompt.NeedsClose, Strings.ZA554);  //Declare the dialog variable
        ...
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(RedMark), 1);  //Adds the Small Energy Potion item to the inventory

            Party.Singleton.ModifyNPC(
                Maps.forbiddenCavernLow,  //Select the map where the modification is applied. Current map in this case.
                "ForbiddenCavernLowChest12",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest20",
                new Point(54,61),  //OpenChest12 is added at position (107,61). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

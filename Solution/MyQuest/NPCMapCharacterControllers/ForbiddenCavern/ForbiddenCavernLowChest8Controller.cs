...
namespace MyQuest
{
    public class ForbiddenCavernLowChest8Controller : NPCMapCharacterController
    {
        ...
        {
            Party.Singleton.GameState.Inventory.AddItem(typeof(BlueMark), 1);  //Adds the Small Energy Potion item to the inventory

            Party.Singleton.ModifyNPC(
                Maps.forbiddenCavernLow,  //Select the map where the modification is applied. Current map in this case.
                "ForbiddenCavernLowChest8",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest16",
                new Point(51,39),  //OpenChest8 is added at position (51,39). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

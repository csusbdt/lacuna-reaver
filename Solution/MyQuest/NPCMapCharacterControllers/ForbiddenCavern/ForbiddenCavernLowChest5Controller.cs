...
namespace MyQuest
{
    public class ForbiddenCavernLowChest5Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernLowChest5",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest13",
                new Point(52,31),  //OpenChest5 is added at position (52,31). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

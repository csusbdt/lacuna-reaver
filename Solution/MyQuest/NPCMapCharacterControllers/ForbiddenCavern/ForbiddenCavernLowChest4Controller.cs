...
namespace MyQuest
{
    public class ForbiddenCavernLowChest4Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernLowChest4",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "OpenChest12",
                new Point(13,30),  //OpenChest4 is added at position (13,30). Press D on the keyboard in the game to find the map name and the coordinates.
                ModAction.Add,
                true);

...
namespace MyQuest
{
    public class ForbiddenCavernRoomBGroundChest2Controller : NPCMapCharacterController
    {
        ...
        public override void Interact()  //The interact method will activate when the player presses the A button(or the space bar) on the npc.
        {
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernRoomBGroundChest2",  //The name of the npc being modified
            ...
            Party.Singleton.ModifyNPC(
                ...
                "ForbiddenCavernRoomBGroundChest2",
                Point.Zero,
                ModAction.Remove,
                true);

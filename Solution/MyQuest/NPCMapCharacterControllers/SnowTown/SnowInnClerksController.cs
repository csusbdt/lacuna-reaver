...
namespace MyQuest
{
    public class SnowInnClerksController : NPCMapCharacterController
    {
        #region Fields
        ...
        void Resting(object sender, PartyResponseEventArgs e)
        {
            ...
            CutSceneScreen screen = Utility.CreateInstanceFromName<CutSceneScreen>(this.GetType().Namespace, "WakeUpSnowInnCutSceneScreen");

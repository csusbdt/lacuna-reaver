...
namespace MyQuest
{
    public class WillsBlindedSceneC : Scene
    {
        #region Fields
        ...
        Dialog whatWasThatDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z963, Strings.Z964);

        #endregion

        public WillsBlindedSceneC(Screen screen)
            : base(screen)
        {
        }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            else
            {
                ...
                ScreenManager.Singleton.AddScreen(new DialogScreen(whatWasThatDialog, DialogScreen.Location.TopLeft, "Cara"));

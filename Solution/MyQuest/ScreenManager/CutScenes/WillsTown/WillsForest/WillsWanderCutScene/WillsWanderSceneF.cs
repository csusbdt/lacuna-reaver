...
namespace MyQuest
{
    public class WillsWanderSceneF : Scene
    {
        ...
        public WillsWanderSceneF(Screen screen)
            : base(screen)
        {
        }
        ...
        public override void Initialize()
        {
            ...
            will.MoveSpeed = 1.0f;
            getToPoint = new Point(will.TilePosition.X-3, will.TilePosition.Y);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            else
            {
                ...
                Dialog blindedDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z969);

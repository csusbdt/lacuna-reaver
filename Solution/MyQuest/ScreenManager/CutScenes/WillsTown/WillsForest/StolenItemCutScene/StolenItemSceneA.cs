...
namespace MyQuest
{
    public class StolenItemSceneA : Scene
    {
        #region Fields
        ...
        NPCMapCharacter stolenItem;

        #endregion

        public StolenItemSceneA(Screen screen)
            : base(screen)
        {
        }
        ...
        {
            stolenItem = Party.Singleton.CurrentMap.GetNPC("StolenItem1");

            getToPoint = new Point(stolenItem.TilePosition.X, stolenItem.TilePosition.Y + 1);

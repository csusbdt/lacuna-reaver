...
namespace MyQuest
{
    public class PickPocketsSceneA2 : Scene
    {
        #region Fields
        ...
        Dialog lookDialog = new Dialog(DialogPrompt.NeedsClose, Strings.Z925, Strings.Z926, Strings.Z927, Strings.Z928);

        #endregion

        public PickPocketsSceneA2(Screen screen)
            : base(screen)
        {
        }

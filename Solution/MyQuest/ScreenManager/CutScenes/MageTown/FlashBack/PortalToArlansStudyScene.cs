...
namespace MyQuest
{
    public class PortalToArlansStudyScene : Scene
    {
        Portal portal;
        ...
        public PortalToArlansStudyScene(Screen screen)
            : base(screen)
        {
        }
        ...
        public override void Initialize()
        {
            ...
            portal = new Portal { DestinationMap = "arlans_study", DestinationPosition = new Point(1, 8), Position = Point.Zero };

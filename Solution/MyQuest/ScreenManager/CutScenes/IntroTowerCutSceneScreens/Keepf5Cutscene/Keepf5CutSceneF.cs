...
namespace MyQuest
{
    class Keepf5CutSceneF : Scene
    {
        ...
        public Keepf5CutSceneF(Screen screen)
            : base(screen)
        {
        }
        ...
        public override void Initialize()
        {
            ...
            position = Utility.ToWorldCoordinates(new Point(4, 5), Party.Singleton.CurrentMap.TileDimensions);

            spriteSheet = MyContentManager.LoadTexture(ContentPath.ToMapCharacterTextures + "max_explosion");

...
namespace MyQuest
{
    public class Battle2SceneA : Scene
    {
        double ticker = 0;
        ...
        public Battle2SceneA(Screen screen)
            : base(screen)
        {
        }
        ...
        public override void Initialize()
        {
            ...
            position1 = Utility.ToWorldCoordinates(new Point(0, 12), Party.Singleton.CurrentMap.TileDimensions);
            position2 = Utility.ToWorldCoordinates(new Point(2, 12), Party.Singleton.CurrentMap.TileDimensions);

...
namespace MyQuest
{
    public class Battle1SceneA : Scene
    {
        double ticker = 0;
        ...
        public Battle1SceneA(Screen screen)
            : base(screen)
        {
        }
        ...
        public override void Initialize()
        {
            ...
            position1 = Utility.ToWorldCoordinates(new Point(0, 15), Party.Singleton.CurrentMap.TileDimensions);
            position2 = Utility.ToWorldCoordinates(new Point(2, 15), Party.Singleton.CurrentMap.TileDimensions);

...
namespace MyQuest
{
    public class Battle5SceneA : Scene
    {
        double ticker = 0;
        ...
        public Battle5SceneA(Screen screen)
            : base(screen)
        {
        }
        ...
        public override void Initialize()
        {
            ...
            position1 = Utility.ToWorldCoordinates(new Point(0, 3), Party.Singleton.CurrentMap.TileDimensions);
            position2 = Utility.ToWorldCoordinates(new Point(2, 3), Party.Singleton.CurrentMap.TileDimensions);

...
namespace MyQuest
{
    public class Battle4SceneA : Scene
    {
        double ticker = 0;
        ...
        public Battle4SceneA(Screen screen)
            : base(screen)
        {
        }
        ...
        public override void Initialize()
        {
            ...
            position1 = Utility.ToWorldCoordinates(new Point(0, 6), Party.Singleton.CurrentMap.TileDimensions);
            position2 = Utility.ToWorldCoordinates(new Point(2, 6), Party.Singleton.CurrentMap.TileDimensions);
